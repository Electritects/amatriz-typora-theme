...
Mixed formatting check: <span style="color: purple;"><strong>bold purple annotation</strong></span>, <span style="color: teal;"><em>italic teal annotation</em></span>, and <span style="color: #444444; background: #fffbcc;">muted text on highlight</span> test nested inline emphasis.
